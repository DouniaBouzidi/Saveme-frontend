<template>
  <h1 class="page-header">Your <span style="color: #D41850">songs</span></h1>
    ...
    <div class="row row-cols-auto gap-5 d-flex justify-content-center px-5">
      <div class="col-sm" v-show="!showSpinner">
        <div class="card mb-5 info-card p-5 shadow ">
          <h5 class="list-header mb-5 text-center" style="color: #D41850">Favorites</h5>
      ...
      <div class="col-sm favorite-song" v-show="!showSpinner">
        <div class="mb-4">
